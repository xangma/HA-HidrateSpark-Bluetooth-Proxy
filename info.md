...
An optional Android companion synchronizes individual drinks to Health Connect
through an authenticated, durable sip journal.
...
- ❤️ Retry-safe Health Connect hydration sync (optional Android companion)
